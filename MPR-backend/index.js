...
function execute_TSHARK(callback) {
    ...
    const tSharkScript = exec(`C:/"Program Files"/Wireshark/tshark.exe -i ethernet -w output_capture_file.pcap  -Tjson -e frame.time -e ip.src -e ip.dst -e tcp.srcport -e tcp.dstport -e ip.proto -e frame.len -e ip.hdr_len -e tcp.analysis.bytes_in_flight`)
...
function read_TSHARK(callback) {
    ...
    const tSharkScript = exec(`C:/"Program Files"/Wireshark/tshark.exe -r output_capture_file.pcap -Tjson -e frame.time -e ip.src -e ip.dst -e tcp.srcport -e tcp.dstport -e ip.proto -e frame.len -e ip.hdr_len -e tcp.analysis.bytes_in_flight > output.txt`)
